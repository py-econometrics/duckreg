...
The [bitpacked panel estimators](bitpacked-mundlak.qmd) are currently DuckDB-oriented because the direct bitmap SQL uses `bit_count`/popcount expressions that are not exposed through the backend-neutral Ibis expression layer in this implementation.
