...
Panel event-study bootstrap uses the same idea with the generated event-study design. The [bitpacked panel estimators](bitpacked-mundlak.qmd) use full-sample unit multiplicities against a cached bitmap layout, so bootstrap draws do not rebuild the long panel or bitmap representation.
...
| `BitmapMundlak` | Unit bootstrap using multiplicities against a packed panel layout. |
| `BitmapMundlakEventStudy` | Unit bootstrap using multiplicities against cached cohort-time bitmap moments. |
