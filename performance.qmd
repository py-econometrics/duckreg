...
For dense balanced binary panels, [Bitpacked Panels](bitpacked-mundlak.qmd) documents a lower-level representation that packs unit and time histories into integer words. That path separates one-time layout construction from repeated point-estimate, event-study, and bootstrap moment queries.
